...
<head>
	...
	<!-- Primary Meta Tags -->
    <meta name="description" content="Descoperă statistici privind rezultatele la BAC la nivel județean.">

    <!-- Open Graph / Facebook -->
    <meta property="og:type" content="website" />
    <meta property="og:site_name" content="Bac Plus" />
    <meta property="og:description" content="Descoperă statistici privind rezultatele la BAC la nivel județean." />
    <meta property="og:image" content="https://bacplus.ro/assets/img/sm-image.jpg" />
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:description" content="Descoperă statistici privind rezultatele la BAC la nivel județean.">
...
<body>
		...
		<div class="container">
			...
			<div class="collapse navbar-collapse" id="navbarResponsive">
				<ul class="navbar-nav ml-auto">
					...
					<li class="nav-item">
						<a class="nav-link" href="../judete">Județe
						</a>
					</li>
					<li class="nav-item">
	...
	<div class="container">
		<div class="row">
			<div class="col">
				<h1 class="mt-5 nume">Pagina se încarcă</h1>
				<hr>
			</div>
		</div>
		<script>
			//document.write('<div class="alert alert-success"><strong>Ești clasa a 8-a?</strong> Te invităm să afli despre <a href="https://learningo.ro">noul nostru proiect</a>.</div>');
		</script>
		<div class="row mt-3">
			<div class="col">
				<p>Mai jos puteți vizualiza evoluția județului <b class="nume"></b> la examenul de bacalaureat.</p>
			</div>
		</div>
		...
		<div class="row mt-3">
			<div class="col">
				<p>Mai jos puteți vizualiza distribuția elevilor din județul <b class="nume"></b> în funcție de materia la alegere, materiile obligatorii, specializare, limba modernă și limba maternă.</p>
			</div>
		</div>
	...
	<!-- Info Loader -->
	<script src="../assets/js/loadInfo.js" dataset="info_judete"></script>
